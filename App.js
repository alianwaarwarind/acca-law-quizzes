...
import { ExamState } from './types.js';
import ChapterSelectionScreen from './components/StartScreen.js';
import ExamScreen from './components/ExamScreen.js';
import ResultsScreen from './components/ResultsScreen.js';
import ConfirmationModal from './components/ConfirmationModal.js';

const App = () => {
  const [examState, setExamState] = useState(ExamState.ChapterSelection);
  ...
  const handleStartExam = useCallback((exam) => {
